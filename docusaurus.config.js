...
const config = {
  title: 'Financial Statement Analytics Dashboard',
  tagline: 'We Help You Make Your Report Easy And Fast',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://doc.analytics.ecespro.id/', //Usually your site pulish github pages. domain luar (Edit sesuai dengan url pada Your site is live at di Github Pages)
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Media Sarana Informasi.`,
      },
      prism: {
